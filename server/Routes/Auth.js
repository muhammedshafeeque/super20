...
import { register, login, requestUser, getUserRoles, createUserRole, updateUserRole, deleteUserRole, updateUserDetails, getPermissions } from "../Controller/AuthController.js";

import { PERMISSIONS } from "../Constants/permissions.js";  
import { verifyPermissions, verifyToken } from "../Middleware/AuthMiddleWare.js";
const router = express.Router();

router.post("/register",verifyToken,verifyPermissions(PERMISSIONS.USER.user_create),validateSchema(registerSchema),register);
